        ...
        <div class="app-header">
            <div class="header-content">
                ...
                <div class="header-actions">
                    <a href="../incident_history.php" class="history-btn" title="History">
                        <i class="fas fa-history"></i>
                    </a>
                    <a href="../logout.php" class="logout-btn" onclick="return confirm('Are you sure you want to logout?');" title="Logout">
